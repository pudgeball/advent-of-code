...
fn create_vectors_from_path(input: String) -> HashSet<Point> {
    let mut vectors: HashSet<Point> = HashSet::new();
...
pub fn run(first_wire: String, second_wire: String) -> i64 {
